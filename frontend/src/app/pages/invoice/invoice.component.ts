...
@Component({
      ...
      <mat-card class="data-card">
        <div class="card-toolbar">
          <div>
            ...
            <mat-card-subtitle>Invoice documents, purchase orders, amounts, currency, and PDF access</mat-card-subtitle>
          </div>
          <div class="table-actions" *ngIf="invoiceList.length">
            <mat-form-field appearance="outline" class="search-field">
              ...
              <input
                ...
                placeholder="Invoice, PO, amount, currency, date"
              />
              <button
                *ngIf="searchTerm"
                mat-icon-button
            ...
            <mat-chip-set aria-label="Invoice record count">
        ...
        <div class="table-wrap" *ngIf="invoiceList.length; else emptyState">
          <table mat-table [dataSource]="dataSource" class="invoice-table">
            <ng-container matColumnDef="invoice">
              <th mat-header-cell *matHeaderCellDef>Invoice</th>
              <td mat-cell *matCellDef="let item">
                <span class="primary-cell">{{ item.InvoiceDoc || '-' }}</span>
              </td>
            </ng-container>

            <ng-container matColumnDef="po">
              <th mat-header-cell *matHeaderCellDef>PO</th>
              <td mat-cell *matCellDef="let item">{{ item.PoNo || '-' }}</td>
            </ng-container>
            ...
            <ng-container matColumnDef="amount">
              ...
              <td mat-cell *matCellDef="let item">
                <span class="amount-cell">{{ item.InvoiceAmount || '-' }}</span>
              </td>
            </ng-container>
            ...
            <ng-container matColumnDef="download">
              ...
              <td mat-cell *matCellDef="let item">
                <button
                  ...
                  [disabled]="!item.InvoiceDoc"
                  (click)="downloadPdf(item.InvoiceDoc)"
                >
  ...
  styles: [
    `
      ...
      .invoice-table{width:100%;min-width:860px;background:#fff}
      .invoice-table th{background:#f8f3ef;color:#5e5154;font-size:.75rem;font-weight:800;text-transform:uppercase;letter-spacing:.06em}
      .invoice-table td{color:#2f292b}
      .invoice-table th,.invoice-table td{padding:0 1.15rem;border-bottom:1px solid rgba(87,60,60,.1)}
      .invoice-table tr.mat-mdc-row{height:62px}
      .invoice-table tr.mat-mdc-row:hover{background:#fff8f7}
      ...
      .download-btn{color:#760407}
      .download-btn:hover:not(:disabled){background:#f5e8e7}
...
export class InvoiceComponent implements OnInit {
  ...
  displayedColumns = ['invoice', 'po', 'date', 'amount', 'currency', 'download'];
  invoiceList: Invoice[] = [];
