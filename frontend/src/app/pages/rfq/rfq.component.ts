    ...
    <section class="page-shell">
      ...
      <mat-card class="data-card">
        <mat-card-header>
          ...
          <mat-card-subtitle>Quotation request type, date, vendor, and currency</mat-card-subtitle>
        </mat-card-header>
        <mat-divider></mat-divider>
        <div class="table-wrap">
          <table *ngIf="rfqList.length; else emptyState">
            <thead>
              <tr>
                <th>RFQ</th>
                <th>Type</th>
